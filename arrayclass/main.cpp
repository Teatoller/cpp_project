...
* In this program we are using the Student class from a previous example, 
* to create a course. We'll use an array to create the course, and each 
* element of course will be an instance of Student.
*/
